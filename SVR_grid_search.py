# -*- coding: utf-8 -*-
"""
Created on Sat May 11 23:07:13 2024
...
# Define the regression model with SVR
svr_model = MultiOutputRegressor(SVR())

# Define the parameter grid for the SVR
param_grid = {
    'estimator__kernel': ['linear', 'poly', 'rbf', 'sigmoid'],
    'estimator__C': [0.1, 1, 10],
    'estimator__gamma': ['scale', 'auto'],
    'estimator__epsilon': [0.001, 0.01, 0.1, 0.5]
}

# Initialize the GridSearchCV object
grid_search = GridSearchCV(svr_model, param_grid, cv=5, scoring='neg_mean_squared_error', verbose=2, n_jobs=-1)
